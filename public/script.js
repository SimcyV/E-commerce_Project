...
//function to validate brand name        
        ...
        //     }
         ...
         // function validateInput(productPrice) {
        //     var validationMessage1 = document.getElementById('validationMessage1');
        //     if (productPrice.value < 0) {
        //         productPrice.setCustomValidity('Value must not be less than 0');
        //         validationMessage1.textContent = 'Value for price must not be less than 0';
        //     }else {
        ...
        // function validateInput1(discountPrice) {
        //     var validationMessage2 = document.getElementById('validationMessage2');
        //     if (discountPrice.value < 0) {
        //         discountPrice.setCustomValidity('Value must not be less than 0');
        //         validationMessage2.textContent = 'Value for discount amount must not be less than 0';
        //     }else {
        ...
        //     var msg = document.getElementById("discountError");           
        //     if (discount>=price) {
        //     msg.innerHTML = "Discount amount must be less than price" // Clear the error message 
